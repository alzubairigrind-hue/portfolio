# Portfolio Copy — v1.1 (live copy)

- **Drafted:** 2026-09-22, with the copywriting skill
- **Changed 2026-09-23:** hero secondary link now points to Services (Work moved to 4th and holds one "coming soon" card)
- **Changed 2026-09-24:**
  - The owner kept the v1 wording.
...
## Headline alternatives (swap any time)
- A (in use): "Websites worthy of your business, built to keep running after launch." Answers the template-look worry and carries the main idea.
- B: "Premium landing pages that load fast on every phone." Most concrete, closest to what clients literally ask for.
- C: "Your business deserves more than a template." Directly names the cheap-look worry; bolder, less calm.
